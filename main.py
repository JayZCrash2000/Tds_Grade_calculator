...
st.markdown("""
<h4 align="center"> Dedicating this app to AMIT one of the course TA's for TDS, for his self-less dedication towards teaching us the concepts in depth , friendly and easily understandable way </h4>
""", unsafe_allow_html=True)
